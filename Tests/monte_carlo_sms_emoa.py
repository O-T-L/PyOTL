...
class TestCase(unittest.TestCase):
    ...
    def testCoupleCoupleMonteCarloSMS_EMOA_DTLZ2(self):
        ...
        for _ in range(self.repeat):
            ...
            optimizer = pyotl.optimizer.couple_couple.real.MonteCarloSMS_EMOA(random, problem, initial, crossover, mutation, self.nSamples)
    ...
    def testCoupleCoupleMonteCarloSMS_EMOA_NegativeDTLZ2(self):
        random = pyotl.utility.Random(1)

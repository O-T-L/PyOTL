...
class TestCase(unittest.TestCase):
    ...
    def testIBEA_Epsilon_DTLZ2(self):
        ...
        for _ in range(self.repeat):
            ...
            optimizer = pyotl.optimizer.real.IBEA_Epsilon(random, problem, initial, crossover, mutation, 0.05)
    ...
    def testIBEA_Epsilon_NegativeDTLZ2(self):
        random = pyotl.utility.Random(1)

...
class MonteCarloHV_SMS_EMOA : public otl::optimizer::sms_emoa::couple_couple::SMS_EMOA<_TReal, _TDecision, _TRandom, MakeMonteCarloHypervolume<_TReal, _TRandom> >
{
public:
	...
	typedef otl::optimizer::sms_emoa::couple_couple::SMS_EMOA<TReal, TDecision, TRandom, TMakeHypervolume> TSuper;

...
typedef otl::optimizer::hype::MonteCarloHypE<TReal, TDecision, TRandom &> TMonteCarloHypE;
typedef otl::optimizer::hype::FastMonteCarloHypE<TReal, TDecision, TRandom &> TFastMonteCarloHypE;

...
BOOST_PYTHON_MODULE(PYMODULE_NAME)
{
	...
	boost::python::class_<TOrderBasedCrossover, boost::python::bases<TCoupleCoupleCrossover> >("OrderBasedCrossover", boost::python::init<TRandom &, TReal>())
		.def("GetProbability", &TOrderBasedCrossover::GetProbability)
	;

	boost::python::class_<TPartiallyMappedCrossover, boost::python::bases<TCoupleCoupleCrossover> >("PartiallyMappedCrossover", boost::python::init<TRandom &, TReal>())
		.def("GetProbability", &TPartiallyMappedCrossover::GetProbability)
	;

	boost::python::class_<TPositionBasedCrossover, boost::python::bases<TCoupleCoupleCrossover> >("PositionBasedCrossover", boost::python::init<TRandom &, TReal>())
		.def("GetProbability", &TPositionBasedCrossover::GetProbability)
	;

	boost::python::class_<TSinglePointCrossover, boost::python::bases<TCoupleCoupleCrossover> >("SinglePointCrossover", boost::python::init<TRandom &, TReal, std::vector<size_t> &>())
		.def("GetProbability", &TSinglePointCrossover::GetProbability)
		.def("GetDecisionBits", &TSinglePointCrossover::GetDecisionBits, boost::python::return_value_policy<boost::python::reference_existing_object>())
	;
}
}
}

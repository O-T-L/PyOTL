...
BOOST_PYTHON_MODULE(PYMODULE_NAME)
{
	...
	boost::python::class_<TSimulatedBinaryCrossover, boost::python::bases<TCoupleCoupleCrossover> >("SimulatedBinaryCrossover", boost::python::init<TRandom &, TReal, TSimulatedBinaryCrossover::TBoundary &, TReal>())
		.def(boost::python::init<TRandom &, TReal, TSimulatedBinaryCrossover::TBoundary &, TReal, TReal>())
		.def("GetProbability", &TSimulatedBinaryCrossover::GetProbability)
		.def("GetDistributionIndex", &TSimulatedBinaryCrossover::GetDistributionIndex)
	;

	boost::python::class_<TDifferentialEvolution, boost::python::bases<TXTripleCrossover> >("DifferentialEvolution", boost::python::init<TRandom &, TReal, TDifferentialEvolution::TBoundary &>())
		.def(boost::python::init<TRandom &, TReal, TDifferentialEvolution::TBoundary &, TReal>())
		.def("GetProbability", &TDifferentialEvolution::GetProbability)
		.def("GetScalingFactor", &TDifferentialEvolution::GetScalingFactor)
	;
}
}
}
